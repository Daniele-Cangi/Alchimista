...
COMMON_VERTEX_ENV="VECTOR_BACKEND=vertex_ai_vector_search,VERTEX_INDEX_ID=${VERTEX_INDEX_ID},VERTEX_INDEX_ENDPOINT_ID=${VERTEX_INDEX_ENDPOINT_ID},VERTEX_DEPLOYED_INDEX_ID=${VERTEX_DEPLOYED_INDEX_ID}"
